...
public class GuiDropdown extends GuiButton
{
	...
	{
		super(form, x, y, width, height, new GuiText(form, font, elements.length > 0 ? elements[0] : null));
	...
	public void onMouseClick()
	{
		if (Mouse.getX() < (this.getFadingX() + (this.width / 2)))
		{
			...
			this.text.setText(this.elements.length > 0 ? this.elements[this.selectedElement] : "No Versions Available");
		}
		else
		{
	...
	{
		return this.elements[this.getSelectedElementId()];
	}
